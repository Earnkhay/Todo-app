<template>
    <nav class="nav-item d-flex justify-content-end p-2 logout align-items-center">
          <i class="fa-solid fa-magnifying-glass fw-bold fs-5 p-1 me-3" data-bs-toggle="modal" data-bs-target="#exampleModal"></i>
    ...
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
        ...
        <div class="modal-footer">
            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal" @click="goBack">Close</button>
        </div>
        </div>
    </div>
    </div>
