...
import { collection, onSnapshot, doc, updateDoc, deleteDoc, where, query, orderBy } from "firebase/firestore";
...
export default class undone extends Vue {
    ...
    todosCollectionQuery = query(this.todosCollectionRef, orderBy("date", "desc"), where("done", "==", false));
